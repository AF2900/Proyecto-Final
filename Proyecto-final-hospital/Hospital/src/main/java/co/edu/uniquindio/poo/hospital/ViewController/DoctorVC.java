...
public class DoctorVC {
    ...
    @FXML
    private Button btt_Notificacion;

    @FXML
    private Button btt_citaMedica;

    @FXML
    private Button btt_consulta;

    @FXML
    private Button btt_historialMedico;
    ...
    @FXML
    private ComboBox<Especialidad> cmbx_Especialidad;


    @FXML
    private TableColumn<Doctor, String> tbc_telefono;
    ...
    @FXML
    void initialize() {
        assert Volver != null : "fx:id=\"Volver\" was not injected: check your FXML file 'Doctor.fxml'.";
        ...
        assert btt_Notificacion != null : "fx:id=\"btt_Notificacion\" was not injected: check your FXML file 'Doctor.fxml'.";
        assert btt_citaMedica != null : "fx:id=\"btt_citaMedica\" was not injected: check your FXML file 'Doctor.fxml'.";
        assert btt_consulta != null : "fx:id=\"btt_consulta\" was not injected: check your FXML file 'Doctor.fxml'.";
        assert btt_historialMedico != null : "fx:id=\"btt_historialMedico\" was not injected: check your FXML file 'Doctor.fxml'.";
        ...
        assert tbc_telefono != null : "fx:id=\"tbc_telefono\" was not injected: check your FXML file 'Doctor.fxml'.";
        ...
        assert txt_telefono != null : "fx:id=\"txt_telefono\" was not injected: check your FXML file 'Doctor.fxml'.";
    ...
    public void setApp(App app) {
        ...
        ObservableList<Especialidad> options = FXCollections.observableArrayList(Especialidad.values());
